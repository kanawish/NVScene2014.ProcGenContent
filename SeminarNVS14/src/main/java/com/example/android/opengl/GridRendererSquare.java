...
/**
 * Takes a grid of values, renders.
 */
public class GridRendererSquare {

	private static final String TAG = GridRendererSquare.class.getSimpleName();
	 ...
	 */
	public GridRendererSquare(Context context) throws IOException {
	 ...
	 * @throws java.io.IOException if there was a problem loading shaders from disk.
     */
    public GridRendererSquare(Context context, String vshFilename, String fshFilename) throws IOException {
